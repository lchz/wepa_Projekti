...
//            List<User> followed = user.getFollowings();
            for(User f: user.getFollowings()) {
                if(f.getFamilyname().equals(firstname)) {
                    followed.add(f);
                }
            }
...
//            List<User> followed = user.getFollowings();
            for(User f: user.getFollowings()) {
                if(f.getFamilyname().equals(familyname) && f.getFirstname().equals(firstname)) {
                    followed.add(f);
                }
            }
